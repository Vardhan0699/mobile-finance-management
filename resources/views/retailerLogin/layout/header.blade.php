          ...
          <div class="dropdown-menu header-dropdown">
            <ul class="p-0">
              <li class="dropdown-item">
                <a href="{{ route('retailer.profile',['id' => session('retailer_id')])}}" class="btn p-2 m-0 d-flex align-items-center">
              ...
              <hr class="dropdown-divider">
              <li class="dropdown-item">
                <form method="POST" action="{{ route('retailer.logout') }}" id="logout-form">
                  @csrf
                  <button type="button" id="logout-button" class="btn p-2 m-0 d-flex align-items-center">
